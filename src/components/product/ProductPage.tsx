        ...
        <div className="bg-white">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-0 border-[1px] border-neutr al-200 shadow-sm rounded-sm overflow-hidden">
                ...
                >
                    ...
                    {product.is_popular && (
                        <div className="absolute top-4 left-4 md:top-5 md:left-5 bg-black text-white px-2.5 py-1 text-[9px] uppercase tracking-widest font-medium">
                            Popular Choice
                        </div>
                    )}
                </motion.div>
                ...
                >
                    <div className="space-y-1.5 mb-6 md:mb-8">
                        ...
                        <h1 className="text-3xl md:text-4xl lg:text-5xl font-serif text-neutral-900 leading-tight">
                            {product.name}
                        </h1>
                        <div className="flex items-center gap-3 pt-3">
                            <p className="text-xl md:text-2xl text-neutral-900 font-light font-serif">
                    ...
                    <div className="mb-8 md:mb-10">
                        <label className="text-[9px] uppercase tracking-[0.2em] font-bold text-neutral-900 mb-4 block">
                            SELECT QUANTITY
                        </label>
                    ...
                    <div className="flex flex-col sm:flex-row gap-3 mb-10 md:mb-12">
                        <button
                            ...
                            className="group flex-1 bg-black text-white px-6 md:px-8 py-3.5 md:py-4 text-[10px] uppercase tracking-[0.25em] font-bold hover:bg-neutral-800 transition-all flex items-center justify-center gap-2.5 active:scale-[0.98] rounded-sm"
                        >
                            <ShoppingBag className="w-3.5 h-3.5 group-hover:scale-110 transition-transform" />
                            ADD TO BAG
                        </button>
                        <button className="flex-1 bg-transparent text-black border border-black px-6 md:px-8 py-3.5 md:py-4 text-[10px] uppercase tracking-[0.25em] font-bold hover:bg-black hover:text-white transition-all flex items-center justify-center gap-2.5 rounded-sm">
                            BUY NOW
                        </button>
                    </div>
                    ...
                    <div className="border-t border-neutral-100">
                        {[
                            ...
                            <div key={item.id} className="border-b border-neutral-100">
                                ...
                                >
                                    <span className="text-[10px] text-neutral-900 font-bold tracking-widest uppercase transition-colors group-hover:text-neutral-500">
                                        {item.title}
                                    </span>
                                ...
                                <AnimatePresence>
                                    {openAccordion === item.id && (
                                        ...
                                        >
                                            <div className="pb-6 md:pb-7 text-neutral-600 text-sm md:text-[15px] font-light leading-[1.7] font-serif prose prose-neutral max-w-none">
                    ...
                    {(product.fast_shipping || product.warranty) && (
                        <div className="mt-8 md:mt-10 flex flex-wrap gap-2.5">
                            {product.fast_shipping && (
                                <span className="px-2.5 py-1 bg-neutral-50 text-[9px] text-neutral-500 uppercase tracking-widest border border-neutral-100">
                                    Fast Shipping
                                </span>
                            )}
                            {product.warranty && (
